      ...
      <div class="max-w-4xl w-full space-y-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div class="group relative p-8 rounded-3xl border border-zinc-800 bg-zinc-900/40 transition-all hover:bg-zinc-900/80 hover:border-zinc-700">
            ...
            <p class="text-zinc-500 text-sm font-medium uppercase tracking-[0.2em] mb-4">{{ ls.t()('PROFILE.STATS.INTERACTIONS') }}</p>
            <h3 class="text-5xl font-mono font-bold tracking-tighter">130M+</h3>
          </div>
          <div class="group relative p-8 rounded-3xl border border-zinc-800 bg-zinc-900/40 transition-all hover:bg-zinc-900/80 hover:border-zinc-700">
            <div class="absolute inset-0 bg-gradient-to-tr from-white/5 to-transparent opacity-0 group-hover:opacity-100 rounded-3xl transition-opacity"></div>
            <p class="text-zinc-500 text-sm font-medium uppercase tracking-[0.2em] mb-4">{{ ls.t()('PROFILE.STATS.USERS') }}</p>
            <h3 class="text-5xl font-mono font-bold tracking-tighter">250K+</h3>
          </div>
        </div>
      </div>
    </section>
