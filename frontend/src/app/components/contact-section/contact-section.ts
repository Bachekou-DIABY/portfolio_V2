    ...
    <section class="py-24 bg-bg text-text-main px-8 border-t border-border transition-colors duration-300">
      <div class="max-w-4xl mx-auto text-center">
        <header class="mb-16">
          ...
          <p class="text-xl text-text-dim max-w-2xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          <a href="mailto:bac.diaby@gmail.com" 
             class="group p-8 rounded-3xl border border-border bg-bg hover:border-text-main transition-all flex items-center gap-6">
            <div class="w-12 h-12 rounded-2xl bg-text-main text-bg flex items-center justify-center">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
            </div>
            <div class="text-left">
              <p class="text-xs font-bold text-text-dim uppercase tracking-widest mb-1">{{ ls.t()('CONTACT.EMAIL') }}</p>
              <p class="text-lg font-bold">bac.diaby@gmail.com</p>
            </div>
          </a>
          ...
          <a href="tel:+33787094080" 
            ...
            <div class="text-left">
              <p class="text-xs font-bold text-text-dim uppercase tracking-widest mb-1">{{ ls.t()('CONTACT.PHONE') }}</p>
              <p class="text-lg font-bold">07 87 09 40 80</p>
            </div>
          </a>
          ...
          <a href="https://www.linkedin.com/in/bachekou-diaby/" target="_blank"
            ...
            <div class="text-left">
              <p class="text-xs font-bold text-text-dim uppercase tracking-widest mb-1">{{ ls.t()('CONTACT.LINKEDIN') }}</p>
              <p class="text-lg font-bold">Bachekou DIABY</p>
            </div>
          </a>
          ...
          <a href="https://github.com/Bachekou-DIABY" target="_blank"
            ...
            <div class="text-left">
              <p class="text-xs font-bold text-text-dim uppercase tracking-widest mb-1">{{ ls.t()('CONTACT.GITHUB') }}</p>
              <p class="text-lg font-bold">@Bachekou-DIABY</p>
            </div>
          </a>
        </div>
